                          ...
                          @foreach ($users as $user)
                            <tr>
                                <td style="padding-left: 20px;">
                                    ...
                                    @endphp
                                    @if($imageUrl)
                                    <img src="{{ $imageUrl }}" alt="Profile Picture" class="w-9 h-9 rounded-full object-cover">
                                @else
                                    <img src="https://static-00.iconduck.com/assets.00/profile-default-icon-2048x2045-u3j7s5nj.png" alt="Profile Picture" class="w-9 h-9 rounded-full">
                                @endif
                                </td>
