<x-admin-layout>
  ...
  <div class="flex justify-end mb-2">
    ...
    type="button" class="ml-2 text-white bg-gray-800 border border-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center">
