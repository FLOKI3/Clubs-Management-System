        ...
        @can('Create roles')
                <div class="flex justify-end">
                    <a href="{{ route('admin.roles.create') }}" type="button"
                        class="ml-2 text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-green-600 hover:bg-green-700 focus:ring-green-800">Create Role
                    </a>
                </div>
                @endcan
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($roles as $role)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    ...
                                    @can('Edit roles')
                                    <a href="{{route('admin.roles.edit', $role->id)}}" type="button" class="text-white focus:ring-4 focus:outline-none font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
