    ...
    <div class="flex items-center justify-center">
        <div class="p-4 bg-white shadow-md rounded-lg" style="width: 700px">
            ...
            <div class="mt-4 flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Default_pfp.svg/2048px-Default_pfp.svg.png" alt="Bonnie image"/>
        ...
        <div class="mt-4 flex justify-between">
            <a href=""
                class="text-gray-600 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-800">Back</a>
            <button type="submit"
